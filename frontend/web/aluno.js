//const apiUrl = "https://localhost:7020/api/Aluno"; // ajuste a porta conforme sua APIA 
const apiUrl = "https://localhost:7188/api/Aluno"; // ajuste a porta conforme sua APIA 
